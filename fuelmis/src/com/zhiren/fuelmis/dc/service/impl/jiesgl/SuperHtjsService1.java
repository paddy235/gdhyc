 ...
 *
 */
public class SuperHtjsService1 {
	/**
	 * 计算方法
	 * @param rangeList
	 * @param qnetar
	...
	public Map<String,Object> getQnetar(double qnetar){
		...
		if(3800<qnetar && qnetar<4000){
			qnetarPirce = Calculator.mul(Calculator.sub(qnetar, 4000),0.0434);
		...
		if(3600<qnetar && qnetar<3800){
			qnetarPirce = Calculator.mul(Calculator.sub(qnetar, 3800),0.0868);
