...
import com.zhiren.fuelmis.dc.dao.yuebgl.yuebwh.RucrlkcbmdjDao;
 ...
 */
@Service
public class RucrlkcbmdjServiceImpl extends SaveService implements IRucrlkcbmdjService {

	@Autowired
	private JdbcTemplate jdbcTemplate;

	@Autowired
	private RucrlkcbmdjDao rucslDao;
	...
	@Override
	@Transactional
	public JSONArray saveList(Map<String, Object> map) {
		String riq = map.get("riq").toString();
		int intnianf = Integer.parseInt(riq.substring(0,4));
		int intYuef=Integer.parseInt(riq.substring(5,7));
		int shangyyf = intYuef==1?12: intYuef- 1 ;
	...
	public void saveList(List<Map<String,Object>> list){
		for (Map<String,Object> map:list) {
			this.saveData(map,"YUEKCBMDJBHSJB","ID");
		}
	}
}
