...
import com.zhiren.fuelmis.dc.service.yuebgl.yuebwh.IRucrlkcbmdjService;
 ...
 */
@Controller
@RequestMapping("rucrlkcbmdj/biaomdj")
public class RucrlkcbmdjController {
	
	@Autowired
	private IRucrlkcbmdjService rucslService;
	
	@RequestMapping(value = "/getAll")
	public void getAll(@RequestParam(defaultValue="") String riq,
	...
	public void check(@RequestParam(defaultValue="") String riq,
			HttpServletRequest request,HttpServletResponse response) {
		Map<String, Object> map = new HashMap<String,Object>();
	...
	public void createData(@RequestParam(defaultValue="") String riq,
			HttpServletRequest request,HttpServletResponse response) {
		Map<String, Object> map = new HashMap<String,Object>();
		map.put("riq", riq);
	...
	public void saveData(@RequestParam(defaultValue="") String riq,@RequestParam(defaultValue="515") String dianc,
		...
		try {
			writer = response.getWriter();
			writer.write(rucslService.saveList(map).toString());
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
