...
public class SerialConnection implements SerialPortEventListener
		 {
	public static String zhiybmValue;
...
//			portId.removePortOwnershipListener(this);
	...
	public void serialEvent(SerialPortEvent e) {
		...
		case SerialPortEvent.DATA_AVAILABLE:
			...
			zhiybmValue = new String(inputBuffer);
			System.out.println(zhiybmValue);
//			paint(value);
//			messageAreaIn.append(value);
...
//		try {
//			JBarcode localJBarcode = new JBarcode(Code128Encoder.getInstance(), WidthCodedPainter.getInstance(), Code128TextPainter.getInstance());
//
//			BufferedImage localBufferedImage = localJBarcode.createBarcode(str);
//
//			Tank tank = new Tank(localBufferedImage);
//			
//
