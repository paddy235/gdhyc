...
<div class="tab-pane" ng-controller="yuedcaigjhCtrl">
<%--	<div class="navbar navbar-inner block-header">
		<div class="muted pull-left">{{yuedcaigjhTitle}}</div>
	</div>--%>
	<div class="block-content collapse in">
        <div class="span12">
	        <form id="ruczlAdd_form" class="form-horizontal">
				...
				<button style="margin-left: 5px;" my-export="月度采购计划.xls" class="btn btn-primary"><i class="icon-download-alt icon-white"></i> 导出</button>
	        </form>
        </div>
