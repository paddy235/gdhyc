...
<div class="tab-pane" ng-controller="niandrljhCtrl">
<%--	<div class="navbar navbar-inner block-header">
		<div class="muted pull-left">{{niandrljhTitle}}</div>
	</div>--%>
	<div class="block-content collapse in">
        <div class="span12">
	        <form id="ruczlAdd_form" class="form-horizontal">
				...
				<input style="width: 100px;float:left;" id="datepicker" ng-change="refresh()" ng-model="search.year" type="text" >
				...
				<button style="margin-left: 5px;" my-export="年度入炉计划查询.xls" class="btn btn-primary"><i class="icon-download-alt icon-white"></i> 导出</button>
	        </form>
        </div>
