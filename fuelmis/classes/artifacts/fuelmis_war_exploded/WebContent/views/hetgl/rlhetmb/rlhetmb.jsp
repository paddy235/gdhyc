<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<div class="tab-pane" ng-controller="rlhetmbCtrl">
		...
		<div class="span12">
			...
			<form class="form-horizontal ng-pristine ng-valid">
		 	<fieldset> 
		 		<div>    
		              <!--<div class="btn-group">
		              	 <button style="margin-left: 10px;" ng-click="addRlhetmb()" class="btn btn-primary">
		              	 	<i class="icon-plus icon-white"></i> 添加
		              	 </button>	              
		              </div>	              
	
		               <div class="btn-group">
		                 <button style="margin-left: 10px;" ng-click="editRlhetmb()" class="btn btn-info">
		                 	<i class="icon-edit icon-white"></i> 修改
		                 </button>
		              </div>
		              
		              <div class="btn-group">
		                 <button style="margin-left: 10px;" ng-click="delRlhetmb()" class="btn btn-danger">
		                 	<i class="icon-trash icon-white"></i> 删除
		                 </button>
		              </div>           -->
		              <div class="btn-group">
		                 <button style="margin-left: 10px;" ng-click="toHetmb()" class="btn btn-success">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
          	<button type="button" class="btn btn-danger" onclick="deleteRlhetmb()"><i class="icon-ok-sign icon-white"></i> 确认
            </button>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		oTable = $('#example').dataTable({
			"processing" : true,
			"ajax" : "hetgl/rlhtmb/getHetmbList",
			"bAutoWidth" : true,
			"language" : {
	...
	function deleteRlhetmb(){
		$("#example input[type=checkbox]").each(function(){
		    if(this.checked){
		    	$.post("hetgl/rlhtmb/delHetmb",{id:$(this).attr("id")},function(data){
					...
					oTable.fnReloadAjax('hetgl/rlhtmb/getHetmbList');
				},"json");
		    }
		});  
	}
