...
<div id="main-container" ng-controller="hetbeanAdd1Ctrl">
	<div id="picture" style="background-color: white;">
		...
		<div id="first-layer" style="text-align:center;">
			...
			<div style="text-align:center;font-size:22px;margin:20px 0;">煤炭供需合同</div>
		...
		<p style="text-indent:2em;margin-top:10px;">
			2．1 按月完成甲方给乙方的计划供应数量，如果由于乙方原因不能完成计划量的百分之七十按不合格供应商处理，按实际供煤量结算。</p>
		<p style="text-indent:2em;margin-top:10px;">
			2．2 日、月度供需数量由甲方根据机组负荷情况上报乙方，尽量做到均衡拉运。</p>
		<div style="text-align:left;font-size:18px;font-weight:bold;margin:10px 0;">
			3．质量标准与煤质调价：
		</div>
		<div id="second-layer">
			<table class="data-table" style="width:100%;line-height:32px;border-collapse:collapse;">
				...
				<tr>
					<td>发热量（Qnet,ar）</td>
					<td>4300kcal/kg</td>
					<td>热值大于4300kcal/kg，每增加1kcal/kg，价格增加0.0158元/吨；热值在4300－4100kcal/kg，每降低1kcal/kg，价格降低0.0158元/吨；热值在4100－3900kcal/kg，每降低1kcal/kg，价格降低0.0316元/吨。热值低于3900kcal/kg，本化验结果代表的当批煤样不参与全月加权，热值在3900－3700kcal/kg，每降低1kcal/kg，价格降低 0.0632元/吨；热值在3700kcal/kg以下，按工程煤47.00元/吨结算。以3500kcal/kg为基准，每降低1kcal/kg，价格降低0.0134元/吨，每增加1kcal/kg，价格增加0.0134元/吨。</td>
				</tr>
				<tr>
					<td>全水分</td>
					<td><28%</td>
				...
				<tr>
					...
					<td width="50%">
						<table class="contbl" style="width:100%;line-height:45px;padding:20px 10px 40px 10px;">
							<tr>
								<td width="25%">乙方：</td>
								<td width="74%"><label style="text-align:left;margin-left:10px; font-size: 18px;">鄂尔多斯市苏蒙商贸有限责任公司</label></td>
							</tr>
							<tr>
								<td>法定代表人：</td>
								<td>
							...
							<tr>
								<td>地址：</td>
								<td>
									<label class="control-label" style="text-align:left;margin-left:10px;">东胜区那日松南路19号2号楼1</label>
								</td>
							</tr>
							<tr>
								<td>邮编：</td>
							...
							<tr>
								<td>电话：</td>
								<td>
									<label class="control-label" style="text-align:left;margin-left:10px;">15248481622</label>
								</td>
							</tr>
							<tr>
								<td>开户银行：</td>
								<td>
									<label class="control-label" style="text-align:left;margin-left:10px;">中国工商银行股份有限公司鄂尔多斯东兴支行</label>
								</td>
							</tr>
							<tr>
								<td>帐号：</td>
								<td>
									<label class="control-label" style="text-align:left;margin-left:10px;">0612161109100007153 </label>
								</td>
							</tr>
							<tr>
								<td>税号：</td>
								<td>
									<label class="control-label" style="text-align:left;margin-left:10px;">91150602MAOMW5UC43</label>
								</td>
							</tr>
							<tr>
								<td>传真：</td>
