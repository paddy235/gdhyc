<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<div class="tab-pane" ng-controller="priceItemCtrl">
<%--	<div class="navbar navbar-inner block-header">
		<div class="muted pull-left">{{priceItemTitle}}</div>
	</div>--%>
...
<!-- 		           </div> -->
		              ...
		              <div class="btn-group">
		              	 <button style="margin-left: 10px;" ng-click="addPriceItem()" class="btn btn-primary">
		              	 	<i class="icon-plus icon-white"></i> 添加
		              	 </button>	              
		              </div>	              
	
		              <div class="btn-group">
		                 <button style="margin-left: 10px;" ng-click="editPriceItem()" class="btn btn-info">
		                 	<i class="icon-edit icon-white"></i> 修改
		                 </button>
		              </div>
		              
		              <div class="btn-group">
		                 <button style="margin-left: 10px;" ng-click="delPriceItem()" class="btn btn-danger">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
          	<button type="button" class="btn btn-danger" onclick="deletepriceItem()"><i class="icon-ok-sign icon-white"></i> 确认
            </button>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		oTable = $('#example').dataTable({
			"processing" : true,
			"ajax" : "hetgl/priceitem/getPriceItemList",
			"bAutoWidth" : true,
			"language" : {
	...
	function deletepriceItem(){
		$("#example input[type=checkbox]").each(function(){
		    if(this.checked){
		    	$.post("hetgl/priceitem/delPriceItem",{id:$(this).attr("id")},function(data){
					...
					oTable.fnReloadAjax('hetgl/priceitem/getPriceItemList');
				},"json");
		    }
		});  
	}
