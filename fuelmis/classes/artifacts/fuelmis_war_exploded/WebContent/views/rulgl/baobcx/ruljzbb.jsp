...
<div class="tab-pane" ng-controller="ruljzbbCtrl">
	<div class="block-content collapse in ">
		<div class="span12">
			<div class="table-toolbar">
				<form class="form-horizontal ng-pristine ng-valid">
					<label style="width:40px;margin-right:5px;" class="control-label">日期:</label>
					<input ng-click="searchData()" id="datepicker1" type="text" style="float: left;width: 120px;" ng-model="search.sDate">
					<label style="width:15px;margin:0 5px;" class="control-label">至</label>
					<input ng-click="searchData()" id="datepicker2" type="text" style="float: left;width: 120px;" ng-model="search.eDate">
					...
					<button style="margin-left: 10px;" my-export="入炉检质报表.xls" class="btn btn-primary">
