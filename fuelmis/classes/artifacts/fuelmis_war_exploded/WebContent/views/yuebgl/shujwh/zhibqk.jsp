...
<div class="tab-pane" ng-controller="zhibqkCtrl">
		...
		<div class="span12" style="height: 42px;">
			<div class="table-toolbar">
				<form class="form-horizontal ng-pristine ng-valid">
					...
					<!-- 
					<button style="margin-left: 10px;" ng-click="printTable()" class="btn">打印</button>
					-->
				</form>
			</div>
		</div>
			...
			<table class="table table-striped table-bordered table-hover" id="example">
				<thead>
					<tr>
						...
						<th style="text-align: center; ">项目1</th>
						<th style="text-align: center; ">单位1</th>
						<th style="text-align: center; ">值1</th>
						<th style="text-align: center; ">项目2</th>
						<th style="text-align: center; ">单位2</th>
						<th style="text-align: center; ">值2</th>
					</tr>
				</thead>
				<tbody>
					<tr ng-repeat="sub in zhibqkList">
						<td style="text-align: right;">{{$index+1}}</td>
						<td style="text-align: center;">{{sub.xiangm1}}</td>
						<td style="text-align: center;">{{sub.danw1}}</td>
						<td style="text-align: right;">
							<span ng-if="sub.gongs1!=''&&sub.gongs1!=null">{{sub.zhi1}}</span>
							<input ng-chang="cal(sub)" ng-if="sub.gongs1==''||sub.gongs1==null" type="text" style="width: 80px;text-align: right;" ng-model="sub.zhi1">
						</td>
						<td style="text-align: center;">{{sub.xiangm2}}</td>
						<td style="text-align: center;">{{sub.danw2}}</td>
						<td style="text-align: right;">
							<span ng-if="sub.gongs2!=''&&sub.gongs2!=null">{{sub.zhi2}}</span>
							<input ng-if="sub.gongs2==''||sub.gongs2==null" type="text" style="width: 80px;text-align: right;" ng-model="sub.zhi2">
						</td>
					</tr>
				</tbody>
			</table>
