...
<div class="tab-pane" ng-controller="huaytzCtrlByRiq">
            ...
            <form id="ruczlAdd_form" class="form-horizontal">
                <fieldset>
                    <div class="control-group ">
                        ...
                        <input id="datepicker1" ng-change="refresh()" ng-model="search.strdate" type="text"
                               style="width:120px;float:left">
                        <label class="control-label" style="width:100px;margin-right:5px;">来煤结束时间:</label>
                        <input id="datepicker2" ng-change="refresh()" ng-model="search.enddate" type="text"
                               style="width:120px;float:left">
