...
<div class="tab-pane" ng-controller="shiscbhsCtrl">
		...
		<div class="span12">
			<div class="table-toolbar">
				<form class="form-horizontal ng-pristine ng-valid">
					...
					<button style="margin-left: 10px;" my-export="实时成本核算报表.xls" class="btn btn-primary">
	...
	<div class="row-fluid"  style="width: 100%;margin-left: auto;margin-right: auto;overflow: auto;">
	<div id="report" style="width: 1780px"></div>
	</div>
