...
<div class="tab-pane" ng-controller="jiestzCtrl">
			...
			<form class="form-horizontal ng-pristine ng-valid">
				<div class="table-toolbar">
					...
					<select ng-model="search.diancid"  style="float: left;width: 120px;"
						ng-options="option.value as option.name for option in diancList" ng-change="searchData()"></select>
					<label style="width:70px;margin-right:5px;" class="control-label">日期:</label>
					<input id="datepicker1" type="text" style="float: left;width: 75px;" ng-model="search.sDate" ng-change="searchData()" >
					<label style="width:15px;margin:0 5px;" class="control-label">至</label>
					<input id="datepicker2" type="text" style="float: left;width: 75px;" ng-model="search.eDate" ng-change="getHet()">
					...
					<select ng-model="search.HETBH"  style="float: left;width: 200px;margin-right:30px;" ng-change="searchData()"
						ng-options="option.value as option.name for option in hetongList">
					</select>
				   <!--  <input type="checkbox" id="ruzrq"><label style="display:inline-block;height:30px;line-height:30px;width:70px;margin-left:5px;">入账日期</label> -->
					...
					<button my-export="结算统计台帐.xls" style="margin-left: 10px;"  class="btn btn-primary">
