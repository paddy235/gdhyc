...
<div class="tab-pane" ng-controller="hycmeikjs_subCtrl">
    <div class="block-content collapse in ">
        <div class="span12">
            <div class="table-toolbar">
                <form class="form-horizontal ng-pristine ng-valid">
                    <button style="margin-left: 10px;" id="reback" ng-click="reback()" class="btn">
        ...
        <div class="row-fluid">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="mtab">
                ...
                <tr>
                    ...
                    <td><span class="textmspan">{{jiesd.HETZBZDJ}}</span></td>
                    <td>{{jiesd.BUHSDJ}}</td>
                ...
                <tr>
                    <td>运杂费合计大写</td>
                    <td colspan="8"><span class="textmspan">￥{{jiesd.YUNZFHJDX}}零元整</span></td>
                </tr>
                <tr>
                    <td>合计大写</td>
                    <td colspan="5"><span class="textmspan">￥{{jiesd.MEIKDJDX}}</span></td>
                    <td>合计小写</td>
