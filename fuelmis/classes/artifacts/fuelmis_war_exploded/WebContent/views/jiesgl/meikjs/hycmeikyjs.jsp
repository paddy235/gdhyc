			...
			<div class="span12">
				<div class="table-toolbar">
		           ...
		           <select style="width:120px; float: left;"  ng-model="search.GONGYSB_ID" ng-change="getPinzList()"
					ng-options="option.value as option.name for option in gongysList_meikjs">
					</select>
	             ...
	             <thead>
	             	<tr>
	                   ...
	                   <%--  <th style="text-align: center; width: 80px;">{{}}</th>--%>
	                     ...
	                     <th style="text-align: center; width: 50px;">灰分(aad)</th>
	                     <th style="text-align: center; width: 50px;">{{hetj.AAD}}</th>
