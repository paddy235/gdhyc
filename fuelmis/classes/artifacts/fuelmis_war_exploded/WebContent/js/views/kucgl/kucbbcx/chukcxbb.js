gddlapp.controller('chukcxbbCtrl', function($scope, $rootScope,$routeParams, $http/*,$location*/) {
	//--------------------------------------日期定义--------------------------------------------------------------------------
	...
	$scope.searchData = function() {
		$http.post('kucgl/kucbb/getChukcxbb',{search:angular.toJson($scope.search)}).success(function(data) {
