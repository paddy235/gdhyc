gddlapp.controller('zhilysbbCtrl', function($scope,$rootScope,$http,$log,$location) {
	$scope.zhilysbbTitle='质量验收报表';  
	//var date = new Date();
	...
	$scope.searchData = function() {
		...
		$http.post('yuebgl/guodbb/getZhilysbb',{riq:riq,dianc:diancid,leix:leix}).success(function(data) {
