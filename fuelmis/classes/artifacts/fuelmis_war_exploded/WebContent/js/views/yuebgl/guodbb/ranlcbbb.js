gddlapp.controller('ranlcbbbCtrl', function($scope,$rootScope,$http,$log,$location) {
	$scope.ranlcbbbTitle='燃料成本报表';
	//var date = new Date();
	...
	$http.post('yuebgl/guodbb/getRanlcbbb').success(function(data) {
	...
	$scope.searchData = function() {
		...
		$http.post('yuebgl/guodbb/getRanlcbbb',{riq:riq,dianc:diancid}).success(function(data) {
			document.getElementById("report").innerHTML = data[0].html;
