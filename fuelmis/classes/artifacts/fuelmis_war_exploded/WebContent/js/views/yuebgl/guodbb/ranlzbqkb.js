gddlapp.controller('ranlzbqkbCtrl', function($scope,$rootScope,$http,$log,$location) {
	$scope.ranlzbqkbTitle='燃料指标情况表';
	//var date = new Date();
	...
	$http.post('yuebgl/guodbb/getRanlzbqkb',{riq:$scope.search.riq,dianc:$scope.search.diancid}).success(function(data) {
	...
	$scope.searchData = function() {
		...
		$http.post('yuebgl/guodbb/getRanlzbqkb',{riq:riq,dianc:diancid}).success(function(data) {
			document.getElementById("report").innerHTML = data[0].html;
