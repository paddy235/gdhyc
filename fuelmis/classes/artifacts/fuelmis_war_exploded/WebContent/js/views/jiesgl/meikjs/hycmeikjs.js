...
//      复选框全选
    ...
    $scope.calculatehej = function (list) {
        ...
        angular.forEach(list, function (data, index, array) {
            ...
            AAD_HEJ += Number(array[index].AAD) * Number(array[index].JINGZ);
        ...
        $scope.hetj.AAD = AAD_HEJ.toFixed(2);
...
//	    结算
    ...
    $scope.jiesd.SHUIK = (Number($scope.jiesd.MEIKJE)-Number($scope.jiesd.MEIKJE)/1.17).toFixed(2);
