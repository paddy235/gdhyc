gddlapp.controller('siscxCtrl', function($scope,$rootScope,$http,$log,$location) {
	$scope.siscxTitle='SIS数据查询';
	var date = new Date();
	...
	$http.post('rulgl/baobcx/getSIS_shujcx').success(function(data) {
	...
	$scope.searchData = function() {
		...
		$http.post('rulgl/baobcx/getSIS_shujcx',{riq:riq})
