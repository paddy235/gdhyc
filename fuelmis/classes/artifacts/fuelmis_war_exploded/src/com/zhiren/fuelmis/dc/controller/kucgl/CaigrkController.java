 ...
 */
@Controller
@RequestMapping("/kucgl/caigrk")
public class CaigrkController {
	@Autowired
	private ICaigrkService caigrkService;
	
	@RequestMapping(value = "/getAll")
	public void getAll(@RequestParam(defaultValue="") String sDate,@RequestParam(defaultValue="") String eDate,
