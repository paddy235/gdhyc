...
public class RulZhildrJob {
	...
	public void execute() {
		String sql = "SELECT PK_ORG_BM,'入炉化验' LEIX,ASSAYCODE,ASSAYDATE,ASSAYUSER,\n" +
					...
					"  HAD,nvl(HDAF,0)HDAF,nvl(HAR,0)HAR,HD,QBAD,QGRAD,QGRD,nvl(QGRADDAF,0)QGRADDAF,nvl(QGRAR,0)QGRAR,QNETAR,\n" + 
	...
	public void update(Map<String, Object> map) {
		String sql = "update rl_hy_huaydb set HUAYSJ='"
				...
				+ map.get("QGRAD_DAF").toString() + "',SDAF='"
