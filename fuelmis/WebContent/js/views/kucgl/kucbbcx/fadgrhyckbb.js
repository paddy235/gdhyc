gddlapp.controller('fadgrhyckbbCtrl', function($scope, $rootScope,$routeParams, $http,$location) {
	...
	$scope.searchData = function() {
		$http.post('kucgl/kucbb/getFadgrckhybb',{search:angular.toJson($scope.search)}).success(function(data) {
