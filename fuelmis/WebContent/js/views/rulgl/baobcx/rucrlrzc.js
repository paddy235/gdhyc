gddlapp.controller('rucrlrzcCtrl', function($scope,$rootScope,$http,$log,$location) {
	$scope.rucrlrzcTitle='入厂入炉煤热值差';
	var date = new Date();
	...
	$http.post('rulgl/baobcx/getRucrlrzc').success(function(data) {
	...
	$scope.searchData = function() {
		...
		$http.post('rulgl/baobcx/getRucrlrzc',{sDate:sDate,eDate:eDate})
