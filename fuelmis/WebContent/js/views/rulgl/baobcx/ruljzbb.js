gddlapp.controller('ruljzbbCtrl', function($scope,$rootScope,$http,$log,$location) {
	$scope.ruljzbbTitle='检质报表';
	var date = new Date();
	...
	$http.post('rulgl/baobcx/getRuljzbb').success(function(data) {
	...
	$scope.searchData = function() {
		...
		$http.post('rulgl/baobcx/getRuljzbb',{sDate:sDate,eDate:eDate,dianc:diancid})
