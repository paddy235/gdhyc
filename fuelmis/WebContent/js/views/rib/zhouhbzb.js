gddlapp.controller('zhouhbzbCtrl', function($scope,$rootScope,$http,$log,$location) {
	...
	$http.post('zhouhbzb/ribcx',{kaisriq:$scope.search.kaisriq,jiezriq:$scope.search.jiezriq,diancid:$scope.search.diancid,baobleix:$scope.search.baobleix}).success(function(data) {
