gddlapp.controller('meishcbbCtrl', function($scope,$rootScope,$http,$log,$location) {
	...
	$http.post('yuebgl/guodbb/getMeishcbb').success(function(data) {
	...
	$scope.searchData = function() {
		...
		$http.post('yuebgl/guodbb/getMeishcbb',{riq:riq,dianc:diancid,leix:leix}).success(function(data) {
            document.getElementById("report").innerHTML = data[0].html;
