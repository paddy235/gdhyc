gddlapp.controller('rulmrzCtrl', function($scope,$rootScope,$http,$log,$location) {
	$scope.rulmrzTitle='入炉煤热值';
	//var date = new Date();
	...
	$http.post('yuebgl/guodbb/getRulmrz').success(function(data) {
	...
	$scope.searchData = function() {
		...
		$http.post('yuebgl/guodbb/getRulmrz',{riq:riq,dianc:diancid}).success(function(data) {
			document.getElementById("report").innerHTML = data[0].html;
