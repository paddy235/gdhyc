gddlapp.controller('Dianmcgjgyb', function($scope,$rootScope,$http,$log,$location) {
	...
	$http.post('yueb/guodbb/getMeishcbb').success(function(data) {
	...
	$scope.searchData = function() {
		...
		$http.post('yueb/guodbb/getMeishcbb',{riq:riq,dianc:diancid,leix:leix}).success(function(data) {
			document.getElementById("report").innerHTML = data[0].html;
