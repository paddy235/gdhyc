gddlapp.controller('duibbmdj1', function ($scope, $rootScope, $routeParams, $http, $location) {
        ...
        // 查重
        $scope.save = function () {
            $http.post('duibbmdj/xianggwh/delMeiHy', {
                ids: angular.toJson($scope.delArray)
            }).success(function (data) {
                $http.post('duibbmdj/xianggwh/updateMeihy', {
    ...
    $scope.searchData = function() {
        $http.post('duibbmdj/xianggwh/getMeiHy',{condition:angular.toJson($scope.search)}).success(function(data) {
            $scope.list=data;
