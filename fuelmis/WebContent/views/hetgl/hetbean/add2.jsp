	...
	<body>
		<div id="main-container">
			...
			<div id="first-layer" style="text-align:center;">
				...
				<div style="text-align:center;font-size:22px;margin:20px 0;">GDDS-RD-RM-2016-110</div>
				<table style="width:100%;line-height:40px;margin-top:50px;margin-bottom:50px;">
					<tr>
						<td width="50%">甲方：<input type="text" style="font-size:18px;width:50%;border:none;border-bottom:1px solid #444;"></td>
					</tr>
					<tr>
						<td>乙方：<input type="text" style="font-size:18px;width:50%;border:none;border-bottom:1px solid #444;"></td>
					</tr>
				</table>
			</div>
			<div style="text-align:center;font-size:26px;font-weight:bold;margin:20px 0;">
			...
			<div style="text-align:left;font-size:20px;font-weight:bold;margin:15px 0;">
				甲方：国电新疆红雁池发电有限公司
			</div>
			<div style="text-align:left;font-size:20px;font-weight:bold;margin:15px 0;">
				乙方：鄂尔多斯市亿利煤炭有限责任公司
			...
			<div style="text-align:left;font-size:18px;font-weight:normal;margin:10px 0;">
				经甲、乙双方共同协商，就2016年工程煤供需事宜达成一致意见，并签订本合同。
			</div>
			...
			<div id="second-layer">
				<table class="data-table" style="width:100%;line-height:32px;border-collapse:collapse;">
					...
					<tr>
						<td>发热量（Qnet,ar）</td>
						<td>3500kcal/kg</td>
						<td>热值大于3500kcal/kg，每增加1kcal/kg，价格增加0.016元/吨，热值小于3500kcal/kg，每降低1kcal/kg，价格降低0.016元/吨。</td>
					</tr>
					<tr>
						<td>粒度</td>
						<td>0～100mm</td>
			...
			<p style="text-indent:2em;margin-top:10px;">
			5．1 合同价格：煤价（一票到厂含税价）：56.00元/吨,大写：伍拾陆元整每吨.</p>
			<p style="text-indent:2em;margin-top:10px;">
			...
			<p style="text-indent:2em;margin-top:10px;">
			6．3 甲、乙双方均有到现场监督的权利，但不能影响和干预质检单位采、制、化工作在“公开、公平、公正”的原则下独立进行。来煤夹杂沙、石、土、矸石及其它杂物，甲方有权扣除一定数量的吨位、拒付当日（车）煤款或解除合同；同一车煤上下煤质不一致，有明显的弄虚作假现象，甲方有权根据情况扣除当车煤量或解除合同，扣除情况需经乙方在三个工作日签字确认并履行相关手续否则视为同意。</p>
			<p style="text-indent:2em;margin-top:10px;">
			...
			<p style="text-indent:2em;margin-top:10px;">
			甲、乙双方对执行合同发生的一切争执，本着友好合作的精神共同协商解决。若协商不能达成一致的，双方都可向甲方所在地人民法院起诉。</p>
			<div style="text-align:left;font-size:18px;margin:10px 0;">
			...
			<div style="margin-top:50px;">
				<table style="width:100%;line-height:45px;border-collapse:collapse;font-size:18px;">
					<tr>
						<td width="50%">
							<table class="contbl" style="width:100%;line-height:45px;padding:20px 10px 40px 10px;">
								<tr>
									<td width="25%">甲方：</td>
									<td width="74%">国电新疆红雁池发电有限公司 </td>
								</tr>
								<tr>
									<td>法定代表人：</td>
									<td>内蒙古鄂尔多斯市东胜区富兴北路18号</td>
								</tr>
								<tr>
									<td>授权代表:</td>
									<td><input type="text" style="font-size:22px;width:80%;border:none;border-bottom:1px solid #444;"></td>
								</tr>
								<tr>
									<td>地址：</td>
									<td><input type="text" style="font-size:22px;width:80%;border:none;border-bottom:1px solid #444;"></td>
						...
						<td width="50%">
							<table class="contbl" style="width:100%;line-height:45px;padding:20px 10px 40px 10px;">
								<tr>
									<td width="25%">乙方：</td>
									<td width="74%">鄂尔多斯市亿利煤炭有限责任公司</td>
								</tr>
								<tr>
									<td>法定代表人：</td>
									<td><input type="text" style="font-size:22px;width:80%;border:none;border-bottom:1px solid #444;"></td>
