...
<html>
	...
	<body>
		<div id="main-container" ng-controller="hetbeanAdd1Ctrl">
			...
			<p style="text-indent:2em;margin-top:10px;">
			2．2 日度、月度供需数量由甲方根据机组负荷情况上报乙方，尽量做到均衡拉运。</p>
			<div style="text-align:left;font-size:18px;font-weight:bold;margin:10px 0;">
				3．质量标准与煤质调价：
			</div>
			<div id="second-layer">
				<table class="data-table" style="width:100%;line-height:32px;border-collapse:collapse;">
					...
					<tr>
						<td>全硫(St,ar)</td>
						<td>≤0.5％</td>
						<td>收到基全硫(St,ar)大于0.5％，在0.5％－0.6％之间，以0.5%为基数，每超出0.01％，价格降低0.2元/吨；收到基全硫(St,ar)在0.6%-0.7％之间，以0.6％为基数，每超出0.01％，价格降低0.4元/吨；收到基全硫（st，ar）在0.7%-0.8%之间，以0.7%为基数，每超0.01%，价格降低0.8元/吨；收到基全硫(St,ar)在0.8%-0.9％之间，以0.8％为基数，每超出0.01％，价格降低1.6元/吨；收到基全硫（st，ar）在0.9%-1.0%之间，以0.9%为基数，每超0.01%，价格降低3.2元/吨。以此类推。</td>
					</tr>
					<tr>
						<td>发热量（Qnet,ar）</td>
						<td>4300kcal/kg</td>
						<td>热值大于4300kcal/kg，每增加1kcal/kg，价格增加0.0233元/吨；热值在4300－4100kcal/kg，每降低1kcal/kg，价格降低0.0233元/吨；热值在4100－3900kcal/kg，每降低1kcal/kg，价格降低0.0466元/吨。热值低于3900kcal/kg，本化验结果代表的当批煤样不参与全月加权，热值在3900－3700kcal/kg，每降低1kcal/kg，价格降低 0.0932元/吨；热值在3700kcal/kg以下，按工程煤56.00元/吨结算，以3500kcal/kg为基准，每降低1kcal/kg，价格降低0.016元/吨，每增加1kcal/kg，价格增加0.016元/吨。</td>
					</tr>
					<tr>
						<td>粒度</td>
						<td>0～100mm</td>
			...
			<p style="text-indent:2em;margin-top:10px;">
			6．3 甲、乙双方均有到现场监督的权利，但不能影响和干预质检单位采、制、化工作在“公开、公平、公正”的原则下独立进行。来煤夹杂沙、石、土、矸石及其它杂物，甲方有权扣除一定数量的吨位、拒付当日（车）煤款或解除合同；同一车煤上下煤质不一致，有明显的弄虚作假现象，甲方有权根据情况扣除当车煤量或解除合同，扣除情况需经乙方确认并履行相关手续。</p>
			<p style="text-indent:2em;margin-top:10px;">
			...
			<p style="text-indent:2em;margin-top:10px;">
			8．2一旦双方就修改意见达成一致，应以补充协议形式并且双方盖章确认，视为本合同的有效组成部分。</p>
			<div style="text-align:left;font-size:18px;font-weight:bold;margin:10px 0;">
				9．不可抵抗力
			</div>
			<p style="text-indent:2em;margin-top:10px;">
