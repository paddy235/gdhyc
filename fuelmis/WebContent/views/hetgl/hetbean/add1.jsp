...
<!-- 					</tr> -->
					...
					<tr ng-repeat = "kaohzb in kaohzbbList">
					<td align="center">{{$index+9}}</td>
					<td>{{kaohzb.miaos}}</td>
					</tr>
				</table>
			</div>
			<div style="text-align:left;font-size:20px;margin:10px 0;">
				<span style="font-weight:bold;">三、合同价格：</span>
				一票到厂含税单价：
				<input type="text" ng-change="getJiagDx()" ng-model="hetbean.jiag" style="font-size:18px;width:100px;border:none;border-bottom:1px solid #444;">元/吨，
				大写：<input type="text" ng-model="hetbean.jiag_dx" style="font-size:15px;width:300px;border:none;border-bottom:1px solid #444;" readonly="readonly">/吨；
			</div>
			<div style="text-align:left;font-size:20px;margin:10px 0;">
