...
<html>
	...
	<body>
		...
		<div id="picture" style="background-color: white;">
			...
			2．1 按月完成甲方给乙方的计划供应数量，如果由于乙方原因不能完成计划量的百分之七十按不合格供应商处理，按实际供应数量结算。</p>
			<p style="text-indent:2em;margin-top:10px;">
			...
			<div id="second-layer">
				<table class="data-table" style="width:100%;line-height:32px;border-collapse:collapse;">
					...
					<tr>
						<td>发热量（Qnet,ar）</td>
						<td>4300kcal/kg</td>
						<td>热值大于4300kcal/kg，每增加1kcal/kg，价格增加0.0198元/吨；热值在4300－4100kcal/kg，每降低1kcal/kg，价格降低0.0198元/吨；热值在4100－3900kcal/kg，每降低1kcal/kg，价格降低0.0396元/吨。热值低于3900kcal/kg，本化验结果代表的当批煤样不参与全月加权，热值在3900－3700kcal/kg，每降低1kcal/kg，价格降低 0.0792元/吨；热值在3700kcal/kg以下，按工程煤49.00元/吨结算，以3500kcal/kg为基准，每降低1kcal/kg，价格降低0.014元/吨，每增加1kcal/kg，价格增加0.014元/吨。</td>
					</tr>
					<tr>
						<td>全水分</td>
						<td><28%</td>
