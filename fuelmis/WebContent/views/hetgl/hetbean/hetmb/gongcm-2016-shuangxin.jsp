...
<html>
	...
	<body>
		...
		<div id="picture" style="background-color: white;">
			...
			<div id="second-layer">
				<table class="data-table" style="width:100%;line-height:32px;border-collapse:collapse;">
					...
					<tr>
						<td>发热量（Qnet,ar）</td>
						<td>3500kcal/kg</td>
						<td>热值大于3500kcal/kg，每增加1kcal/kg，价格增加0.0111元/吨，热值小于3500kcal/kg，每降低1kcal/kg，价格降低0.0111元/吨。</td>
					</tr>
					<tr>
						<td>全水分</td>
						<td><28%</td>
			...
			<p style="text-indent:2em;margin-top:10px;">
			5．1 合同价格：煤价（一票到厂含税价）：39.00元/吨,大写：叁拾玖元整每吨.
			<p style="text-indent:2em;margin-top:10px;">
			...
			<div style="text-align:left;font-size:18px;margin:10px 0;">
				<span style="font-weight:bold;">12．合同解除和变更：</span>合同期内遇市场价格变动，合同双方在协商一致的情况下签订新的煤炭购销合同，本合同在新合同签字生效后自行终止并解除。若协商不成，甲方有权终止合同执行。
			</div>
			<div style="text-align:left;font-size:18px;margin:10px 0;">
				<span style="font-weight:bold;">13．合同签订地点：</span>鄂尔多斯市东胜区
			</div>
			<div style="text-align:left;font-size:18px;margin:10px 0;">
				<span style="font-weight:bold;">14．其他：</span>本合同一式六份，双方各执三份。
			</div>
					...
					<tr>
						<td width="50%">
							<table class="contbl" style="width:100%;line-height:45px;padding:20px 10px 40px 10px;border-right:1px solid #444;">
								<tr>
									<td width="25%">甲方：</td>
									<td width="74%"><label style="text-align:left;margin-left:10px; font-size: 18px;">国电新疆红雁池发电有限公司</label></td>
								...
								<tr>
									<td>地址：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">鄂尔多斯市东胜区富兴北路18号</label>
																		<!-- <td width="74%"><label style="text-align:left;margin-left:10px; font-size: 18px;">{{dianc.diz}}</label></td> -->
								...
								<tr>
									<td>邮编：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">017000</label>
									<!-- <td width="74%"><label style="text-align:left;margin-left:10px; font-size: 18px;">{{dianc.youb}}</label></td> -->									
									</td>
								</tr>
								<tr>
									<td>电话：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">0477—8396066</label>
									<!-- {{dianc.dianh}}  -->									
								...
								<tr>
									<td>开户银行：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">鄂尔多斯市工行东绒支行</label>
									<!-- {{dianc.kaihyh}}  -->	
									</td>
								</tr>
								<tr>
									<td>帐号：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">0612054619200030410</label>
									</td>
								</tr>
								<tr>
									<td>税号：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">152701783006563</label>
									</td>
								</tr>
								<tr>
									<td>传真：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">0477-8396063</label>
									</td>
								</tr>
							</table>
						</td>
						<td width="50%">
							<table class="contbl" style="width:100%;line-height:45px;padding:20px 10px 40px 10px;">
								<tr>
									<td width="25%">乙方：</td>
									<td width="74%"><label style="text-align:left;margin-left:10px; font-size: 18px;">内蒙古双欣矿业有限公司</label></td>
								</tr>
								<tr>
									<td>法定代表人：</td>
									<td>
								...
								<tr>
									<td>地址：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">东胜区铜川镇</label>
									</td>
								</tr>
								<tr>
									<td>邮编：</td>
								...
								<tr>
									<td>电话：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">13948376961</label>
									</td>
								</tr>
								<tr>
									<td>开户银行：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">中国建设银行股份有限公司鄂尔多斯市分行伊金霍洛西街支行</label>
									</td>
								</tr>
								<tr>
									<td>帐号：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">15001686647052500515</label>
									</td>
								</tr>
								<tr>
									<td>税号：</td>
									<td>
										<label class="control-label" style="text-align:left;margin-left:10px;">15270179017213X</label>
									</td>
								</tr>
								<tr>
									<td>传真：</td>
