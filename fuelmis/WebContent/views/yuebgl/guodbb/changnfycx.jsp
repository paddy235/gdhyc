...
<div class="tab-pane" ng-controller="changnfycxCtrl">
		...
		<div class="span12">
			<div class="table-toolbar">
				<form class="form-horizontal ng-pristine ng-valid">
					...
					<button style="margin-left: 10px;" my-export="厂内费用查询表.xls" class="btn btn-primary">
	...
	<div class="row-fluid" id="report" style="width: 97%;margin-left: auto;margin-right: auto;overflow: auto;"></div>
	<div id="pagination_box" class="pagination pagination-right" style="width: 97%;margin-left: auto;margin-right: auto;">
