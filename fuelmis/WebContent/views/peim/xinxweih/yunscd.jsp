   <%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
    <div class="block" ng-controller="yunschedCtrl">
	    <div class="navbar navbar-inner block-header">
	        <div class="muted pull-left">{{yunschedTitle}}</div>
	    </div>
			...
			<table class="table table-striped table-bordered table-hover" id="example">
             <thead>
                 <tr>
                 	...
                 	<th style="text-align: center; width: 150px;">运输车队名称</th>
                    <th style="text-align: center; width: 150px;">状态</th>
                    <th style="text-align: center; width: 150px;">状态1</th>
                 </tr>
             </thead>
         </table>
       </div>
