...
<base href="<%=basePath%>">
<div class="tab-pane" ng-controller="erjshhtCtrl">
				...
				<tbody>
					<tr ng-repeat="row in list track by $index" class="option">
						...
						<td style="text-align: center; width: 80px;"><br> <br>
							<br>
					<!-- 		<button ng-class="{'b': dis}" id="shenh" ng-click="shenhtg($event.target,row.ID,search.zhuangt)" class="btn btn-success">
