   <%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
    <div class="block" ng-controller="addorupdateniandyssqCtrl">

    <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">{{addorupdateniandyussqTitle}}</div>
    </div>
    ...
    <div class="block-content collapse in">
        ...
        <div style="height:50px;"></div>
	      <div class="control-group">
	        ...
	        <div class="controls">
	          <select id="selectType" ng_model="niandysbean.FEIYMC" >
	      ...
	      <div class="control-group">
	        ...
	        <div class="controls">
	          <input type="text" ng-model="niandysbean.YUSED" id="YUCJE" >
	        </div>
	      </div>
	      <div class="control-group">
	        <label class="control-label" for="inputPassword">说明</label>
	        <div class="controls">
	        	<input type="text" ng-model="niandysbean.SHUOM" id="YUCSM" >
	        </div>
	      </div>
	      <div class="control-group" style="display:none">
	        <label class="control-label" for="inputPassword">日期</label>
	        <div class="controls">
	          <input type="text" ng-model="niandysbean.NIANF"/>
	        </div>
	      </div>
	      <div class="control-group" style="display:none">
	        <label class="control-label" for="inputPassword">电厂id</label>
	        <div class="controls">
	          <input type="text" ng-model="niandysbean.DIANCID" />
	        </div>
	      </div>
	      <div class="control-group" style="display:none">
	        <label class="control-label" for="inputPassword">id</label>
	        <div class="controls">
	          <input type="text" ng-model="niandysbean.ID" />
	        </div>
	      </div>
	      <div class="control-group">
			<div class="controls">
				<button type="button" style="margin-left: 20px;" class="btn btn-primary" ng-click="saveNiandys();">
