...
<div class="tab-pane" ng-controller="yuedrljhCtrl">
<%--	<div class="navbar navbar-inner block-header">
		<div class="muted pull-left">{{yuedrljhTitle}}</div>
	</div>--%>
	<div class="block-content collapse in">
        <div class="span12">
	        <form id="ruczlAdd_form" class="form-horizontal">
				...
				<button style="margin-left: 5px;" my-export="月度入炉计划查询.xls" class="btn btn-primary"><i class="icon-download-alt icon-white"></i> 导出</button>
	        </form>
        </div>
