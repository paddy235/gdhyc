...
<div class="tab-pane" ng-controller="Dianmcgjgrb">
	<div class="block-content collapse in ">
		<div class="span12">
			<div class="table-toolbar">
				<form class="form-horizontal ng-pristine ng-valid">
						<label style="width: 50px;margin-right:5px;" class="control-label">日期:</label>
					<input id="datepicker" type="text" style="float: left;width: 120px;" ng-model="search.sDate">
				...
				<%--	<option value=1 >地区汇总</option>
					<option value=2 >分矿明细</option>							
					</select>--%>
					...
					<button style="margin-left: 10px;" my-export="电煤采购价格日报.xls" class="btn btn-primary">
