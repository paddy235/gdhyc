...
<div class="tab-pane" ng-controller="ranmzhrbb">
	<div class="block-content collapse in">
        <div class="span12">
        <form id="ruczlAdd_form" class="form-horizontal">
             <div class = "form-group">
	             <div class="span12">
		             <label style="width: 60px;margin-right:5px;" class="control-label">报出日期:</label>
					 <input id="datepicker1" ng-model="search.kaisriq" type="text" style="width: 80px;float: left;">
					 <label style="width: 60px;margin:0 5px 0 10px;float: left;" class="control-label">报出:</label>
